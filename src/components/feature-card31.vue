<template>
  <div class="feature-card31-feature-card">
    <svg viewBox="0 0 1024 1024" class="feature-card31-icon">
      <path
    ...
    <h2 class="feature-card31-text">{{ title }}</h2>
    <span class="feature-card31-text1">{{ description }}</span>
    <span class="feature-card31-text2">{{ action }}</span>
  </div>
</template>
