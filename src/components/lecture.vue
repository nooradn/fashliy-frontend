<template>
  <div class="lecture-feature-card" v-bind:class="rootClassName">
    <svg viewBox="0 0 1024 1024" class="lecture-icon">
      <path
    ...
    <h2 class="lecture-text">Aqidah</h2>
    <span class="lecture-text1">{{ text }}</span>
  </div>
</template>
